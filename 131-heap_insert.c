...
/**
 * binary_tree_is_perfect - this funtion  check if the a binary tree is perfect
 *
 * @tree: tree root
...
/**
 * height - this funtion measures the height of the tree
 *
 * @tree: tree root
 * Return: height
 */
...
/**
 * swap - this funtion swaps nodes when child is greater than parent
 *
...
/**
 * heap_insert - this funtion that inserts a value in Max Binary Heap
